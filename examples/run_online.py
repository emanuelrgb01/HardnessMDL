# This script demonstrates how to use the HardnessMDL library in an online learning scenario
#
...
from hardnessmdl import HardnessMDL, SampleType, dataset_utils
...
def main():
    ...
    model = HardnessMDL(n_classes=n_classes, n_dims=args.dimension)
    ...
    for sample_type, features, true_label, correction_label in data_stream:
        ...
        if sample_type == SampleType.TRAINING:
            ...
            prediction = model.hardness(features, true_label)
